...
dataset_train.load_data('hoof_shape/train/labels/shape_coco.json', 'hoof_shape/train')
dataset_train.prepare()

dataset_val = CocoLikeDataset()
dataset_val.load_data('hoof_shape/val/labels/vald_shape_coco.json', 'hoof_shape/val')
dataset_val.prepare()

# define a configuration for the model
class HoofConfig(Config):
	# define the name of the configuration
	NAME = "hoof_shape_cfg_coco"
